<div id="fraktur" class="fraktur-container">
    <a class="app-brand-link justify-content-center">
        ...
        <span class="app-brand-text demo menu-text fw-bold ms-2 mb-1">Astara</span>
    </a>
    ...
    <hr>
    <hr>
    <div class="text-center">{{ session('created_at') ?? '-' }}</div>
