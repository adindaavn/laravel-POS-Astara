...
<div class="row">
    ...
    <div class="col-12 col-md-12 col-xxl-4">
        <div class="row">
            <div class="col-6 col-md-4 col-xxl-6 mb-6">
                <div class="card h-100">
            ...
            <div class="col-12 col-md-4 col-xxl-12 mb-6">
                <div class="card h-100">
                    <div class="card-body">
...
<script>
    ...
    function createChart(categories, transaksiData, penjualanData) {
        var i = config.colors.primary;
        var p = config.colors.secondary;
        let options = {
            series: [{
                    name: "Transaksi",
                    type: 'line',
            ...
            yaxis: [{
                    title: {
                        ...
                        style: {
                            ...
                            fontWeight: '600',
                            fontFamily: 'Poppins, sans-serif',
                            color: '#64748B' // Warna abu-abu soft
                        }
                    }
                },
                {
