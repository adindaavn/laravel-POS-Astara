    ...
    <div class="col-xxl-8 mb-6 order-0">
        <div class="card">
            <div class="d-flex align-items-start row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 id="greeting" class="card-title text-primary mb-3">Loading...</h5>
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body pb-4">
                        ...
                        <h4 class="card-title mb-0">{{ $totalTransaksi }}</h4>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="text-success fw-medium"><i class="icon-base bx bx-up-arrow-alt"></i> +{{ $persenJual }}%</small>
                    </div>
                </div>
            </div>
        </div>
