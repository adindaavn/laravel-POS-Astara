        ...
        _virtualRenderFill(e, t, i) {
            ...
            if (u && r.elVisible(this.elementVertical)) {
                for (
                    ...
                    (a <= p + this.vDomWindowBuffer ||
                        d < this.vDomWindowMinTotalRows) &&
                    this.vDomBottom < u - 1;
                          ...
                          .then((e) => {
                              Array.isArray(e) ||
                                  ...
                                  (e = this.mapParams(
                                      e,
                                      this.objectInvert(
                                          this.table.options.dataReceiveParams
                                      )
                                  ));
    ...
    class Q extends k {
        ...
        focusScrollAdjust(e) {
            if ("virtual" == this.table.rowManager.getRenderMode()) {
                ...
                this.table.modExists("frozenColumns") &&
                    ((o += parseInt(
                        this.table.modules.frozenColumns.leftMargin
                    )),
                    (n -= parseInt(
    ...
    class He extends k {
                ...
                case "string":
                    (t = this.table.rowManager.findRow(e))
                        ? (this._selectRow(t, !0, !0),
                          this._rowSelectionChanged())
                        : ((t = this.table.rowManager.getRows(e)).forEach(
                              (e) => {
                                  this._selectRow(e, !0, !0);
                              }
                          ),
        ...
        deselectRows(e, t) {
            ...
            if (void 0 === e) {
                ...
                for (let e = 0; e < i; e++)
                    s._deselectRow(s.selectedRows[0], !0);
