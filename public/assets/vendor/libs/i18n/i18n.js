            ...
            (function () {
                        ...
                        getRegExp(e) {
                            ...
                            return (
                                this.regExpQueue.length === this.capacity &&
                                    this.regExpMap.delete(
                                        this.regExpQueue.shift()
                                    ),
                ...
                class w {
                    ...
                    emit(e) {
                        for (
                            ...
                            o[n - 1] = arguments[n];
                        if (this.observers[e]) {
                            Array.from(this.observers[e].entries()).forEach(
                                (e) => {
                                    let [t, n] = e;
                ...
                var O = {
                    ...
                    handle(e, t, o, n, s) {
                        return (
                            e.forEach((e) => {
                                t =
                                    this.processors[e]?.process(t, o, n, s) ??
                                    t;
                            }),
                            t
                        );
                ...
                class P extends w {
                    ...
                    translate(t, o, n) {
                        ...
                        if ("cimode" === c?.toLowerCase()) {
                            if (u) {
                                const e =
                                    o.nsSeparator || this.options.nsSeparator;
                                return s
                                    ? {
                                          res: `${l}${e}${r}`,
                                          usedKey: r,
                        ...
                        if (
                            ...
                            if (
                                ...
                                const e = this.options.returnedObjectHandler
                                    ? this.options.returnedObjectHandler(d, p, {
                                          ...o,
                                          ns: a,
                                      })
                ...
                class D {
                    ...
                    nest(t, n) {
                        ...
                        for (; (s = this.nestingRegexp.exec(t)); ) {
                            ...
                            (r = { ...a }),
                                (r =
                                    r.replace && !e(r.replace) ? r.replace : r),
                ...
                class F {
                    ...
                    init(e) {
                        ...
                        this.formatSeparator =
                            t.interpolation.formatSeparator || ",";
                    }
                    add(e, t) {
                    ...
                    format(e, t, o) {
                        ...
                        if (
                            ...
                            s[0] = [s[0], ...s.splice(1, e)].join(
                                this.formatSeparator
                            );
                        }
                        return s.reduce((e, t) => {
                            const { formatName: s, formatOptions: i } = ((
                                e
                            ) => {
                            ...
                            return (
                                this.logger.warn(
                                    `there was no format function for ${s}`
                                ),
                                e
                            );
                        }, e);
                ...
                class I extends w {
                    constructor(e, t, o) {
                        ...
                        super(),
                            ...
                            (this.readingCalls = 0),
                            (this.maxRetries =
                                n.maxRetries >= 0 ? n.maxRetries : 5),
                            (this.retryTimeout =
                                n.retryTimeout >= 1 ? n.retryTimeout : 350),
                            (this.state = {}),
                            (this.queue = []),
                        ...
                        return (
                            e.forEach((e) => {
                                ...
                                t.forEach((t) => {
                                    const r = `${e}|${t}`;
                                    !o.reload &&
                                    this.store.hasResourceBundle(e, t)
                                        ? (this.state[r] = 2)
                                        : this.state[r] < 0 ||
                                          (1 === this.state[r]
                                              ? void 0 === i[r] && (i[r] = !0)
                    ...
                    saveMissing(e, t, o, n, s) {
                        ...
                        if (
                            ...
                            if (null != o && "" !== o) {
                                ...
                                e &&
                                    e[0] &&
                                    this.store.addResource(e[0], t, o, n);
                            }
                        } else
                            this.logger.warn(
                        ...
                        if (!this.options.isClone) {
                            ...
                            (n.logger = S),
                                ...
                                !e ||
                                    ...
                                    (this.options.interpolation.format =
                                        n.formatter.format.bind(n.formatter))),
                    ...
                    loadLanguages(o, n) {
                        ...
                        const i = this.options.preload || [],
                            r = o.filter(
                                (e) =>
                                    i.indexOf(e) < 0 &&
                                    this.services.languageUtils.isSupportedCode(
                                        e
                                    )
                            );
                        return r.length
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (!i || "cimode" !== i.toLowerCase()) {
                                    var r = [],
                                        a = function (e) {
                                            n.toResolveHierarchy(e).forEach(
                                                function (e) {
                                                    r.indexOf(e) < 0 &&
                                                        r.push(e);
                                                }
                ...
                var xe = {
                        ...
                        lookup(e) {
                            ...
                            if (t && be())
                                return (
                                    window.sessionStorage.getItem(t) || void 0
                                );
                        },
                        cacheUserLanguage(e, t) {
                    ...
                    cacheUserLanguage(e) {
                        ...
                        t &&
                            ((this.options.excludeCacheFor &&
                                ...
                                t.forEach((t) => {
                                    this.detectors[t] &&
                                        this.detectors[t].cacheUserLanguage(
                                            e,
                                            this.options
                                        );
                                }));
